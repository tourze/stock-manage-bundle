...
use Tourze\StockManageBundle\Controller\Admin\StockInboundReturnWizardController;

/**
 * @internal
 */
#[CoversClass(StockInboundReturnWizardController::class)]
#[RunTestsInSeparateProcesses]
class StockInboundReturnWizardControllerTest extends AbstractWebTestCase
{
    ...
    {
        $reflection = new \ReflectionClass(StockInboundReturnWizardController::class);
        ...
        $this->assertEquals('/admin/stock/inbound-wizard/return', $route->getPath());
        $this->assertEquals('admin_stock_inbound_return_wizard', $route->getName());
    ...
    public function testControllerClassIntegrity(): void
    {
        ...
        // 检查类名
        $this->assertEquals('StockInboundReturnWizardController', $reflection->getShortName());
