...
use Tourze\StockManageBundle\Controller\Admin\StockInboundProductionWizardController;

/**
 * @internal
 */
#[CoversClass(StockInboundProductionWizardController::class)]
#[RunTestsInSeparateProcesses]
class StockInboundProductionWizardControllerTest extends AbstractWebTestCase
{
    ...
    {
        $reflection = new \ReflectionClass(StockInboundProductionWizardController::class);
        ...
        $this->assertEquals('/admin/stock/inbound-wizard/production', $route->getPath());
        $this->assertEquals('admin_stock_inbound_production_wizard', $route->getName());
    ...
    public function testControllerClassIntegrity(): void
    {
        ...
        // 检查类名
        $this->assertEquals('StockInboundProductionWizardController', $reflection->getShortName());
