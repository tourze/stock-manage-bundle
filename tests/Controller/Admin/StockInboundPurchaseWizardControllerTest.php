...
use Tourze\StockManageBundle\Controller\Admin\StockInboundPurchaseWizardController;

/**
 * @internal
 */
#[CoversClass(StockInboundPurchaseWizardController::class)]
#[RunTestsInSeparateProcesses]
class StockInboundPurchaseWizardControllerTest extends AbstractWebTestCase
{
    ...
    {
        $reflection = new \ReflectionClass(StockInboundPurchaseWizardController::class);
        ...
        $this->assertEquals('/admin/stock/inbound-wizard/purchase', $route->getPath());
        $this->assertEquals('admin_stock_inbound_purchase_wizard', $route->getName());
    ...
    public function testControllerClassIntegrity(): void
    {
        ...
        // 检查类名
        $this->assertEquals('StockInboundPurchaseWizardController', $reflection->getShortName());
